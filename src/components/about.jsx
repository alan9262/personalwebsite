                                ...
                                <div className="row row-bottom-padded-sm animate-box" data-animate-effect="fadeInLeft">
                                    <div className="col-md-12">
                                        <div className="about-desc"><br></br><br></br>
                                            ...
                                            <p>Currently pursuing Information Systems Management at Carnegie Mellon University. With a demonstrated experience in different industries for about 5 years, I have learnt many technologies, starting from learning salesforce and Java, learning and developing excel VBA macros, handling/managing teams and ultimately moving to web development (learning JavaScript and related UI technologies). With my quick grasping ability, constant learning and positive attitude I have successfully achieved different milestones in my career.</p>
