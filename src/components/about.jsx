        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-12">
                ...
                <div className="col-md-12">
                    ...
                    <p>I am a graduate student at Carnegie Mellon University. With a demonstrated experience in different industries for about 5 years, I have received many challenges and domain changes in terms of technologies, starting from learning salesforce and Java, learning and developing excel VBA macros, handling/managing teams and moving to web development (learning JavaScript and related UI technologies). With my quick grasping ability, constant learning and positive attitude I have successfully achieved different milestones in my career. </p>
        ...
        <div className="colorlib-narrow-content">
            ...
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have experience building websites and chrome extentions using JavaScript,React,HTML,CSS,Django</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    ...
                    <p>I have worked on salesforce for about 3 years in different industries - Tesco and Accenture</p>
                </div>
                </div>
            </div>
            <div className="col-md-4 text-center animate-box">
                ...
                <div className="desc">
                    <h3>Java</h3>
                    <p>Have worked on multiple projects using Java, Apache Tomcat for courses Java, Distributed Systems etc.</p>
                </div>
                </div>
            </div>
            {/*
